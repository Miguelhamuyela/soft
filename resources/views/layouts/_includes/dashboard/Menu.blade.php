        ...
        <nav class="vertnav navbar navbar-light">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{ route('admin.signup.index') }}">
                            ...
                            <span class="ml-3 item-text">Registos</span>
                        </a>
                    </li>
                </ul>
                ...
                @if ('Editor' == Auth::user()->level || 'Administrador' == Auth::user()->level)
                    ...
                    <li class="nav-item dropdown">
                        <a href="#schedule" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle nav-link">
                            <i class="fe fe-users fe-16"></i>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#listRestaurants" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle nav-link">
                            <i class="fe fe-file-text fe-16"></i>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#hotelList" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle nav-link">
                            <i class="fe fe-file-text fe-16"></i>
