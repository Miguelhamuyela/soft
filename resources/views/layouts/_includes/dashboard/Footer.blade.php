<footer class="py-1 mt-4 bg-primary">
    ...
    <p class="text-center mt-3 text-white">
        <span>&copy; {{ date('Y') }}, II Reunião Interministerial da Governação Electrónica &  XI Reunião de Ministros das Comunicações da
            CPLP</span> by <a href="https://infosi.gov.ao/"
