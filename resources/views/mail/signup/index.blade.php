                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="http://www.rmc.cplp.ao/site/images/cplp-logo.png"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>
                                                                        <span style="font-size: 25px; line-height: 38px;">
                                                                            ...
                                                                            @if (isset($signup['msg']))
                                                                                Sua inscrição foi Aprovada para participar da II Reunião Interministerial da Governação Electrónica & XI Reunião de Ministros das Comunicações da CPLP.
                                                                      
                                                                            @else
                                                                                Obrigado
                                                                                por realizar a sua inscrição para participar
                                                                                da II Reunião Interministerial da Governação Electrónica & XI Reunião de Ministros das Comunicações da CPLP
                                                                            @endif
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">Data de Chegada</span></strong>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">Data de Partida</span></strong>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">País</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{ $signup['country'] }}</span>
                                                                </p>
                                                            </div>
